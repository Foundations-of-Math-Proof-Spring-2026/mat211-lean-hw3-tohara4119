...
What does the tactic "extra" do in the following example?
-/
...
/-
This example is here because Heather Macbeth said it's "wild".
Why does she say it's wild other than because there's so much algebra?
-/
